...
@section('content')
    <main class="pt-90">
        ...
        <section class="shop-checkout container">
            ...
            <form name="checkout-form" action="{{ route('cart.order') }}" method="POST">
                @csrf
                                    ...
                                    <div class="card shadow-sm h-100">
                                        <div class="card-body">
                                            ...
                                            <div class="card-text text-muted">
                                                ...
                                                <p class="mb-1">{{ $address->state }}, {{ $address->zip }}</p>
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating my-3">
                                        <input type="text" class="form-control @error('landmark') is-invalid @enderror"
                                            name="landmark" required value="{{ old('landmark') }}">
                                ...
                                @if (Session::has('discount'))
                                    <table class="checkout-totals">
                                        <tbody>
                                            <tr>
                                                <th>SUBTOTAL</th>
                                                <td align="right">Rp{{ Session::get('discounts')['subtotal'] ?? '' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>SHIPPING</th>
                                            ...
                                            <tr>
                                                <th>VAT</th>
                                                <td align="right">Rp{{ Session::get('discounts')['tax'] ?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <th>TOTAL</th>
                                                <td align="right">Rp{{ Session::get('discounts')['total'] ?? '' }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                @else
