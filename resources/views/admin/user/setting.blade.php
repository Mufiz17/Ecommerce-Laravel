                            ...
                            <div class="my-account__edit-form">
                                <form name="account_edit_form" action="{{ route('admin.setting.update') }}" method="POST"
                                    ...
                                    <fieldset class="name">
                                        ...
                                        <input class="flex-grow @error('name') is-invalid @enderror" type="text" placeholder="Full Name" name="name"
                                            tabindex="0" value="{{ $user->name }}" aria-required="true" required="">
                                    </fieldset>

                                    <fieldset class="name">
                                        <div class="body-title">Email Address <span class="tf-color-1">*</span></div>
                                        <input class="flex-grow @error('email') is-invalid @enderror" type="text" placeholder="Email Address" name="email"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <fieldset class="name">
                                                ...
                                                <input class="flex-grow @error('password') is-invalid @enderror" type="password" placeholder="Old password"
                                        ...
                                        <div class="col-md-12">
                                            <fieldset class="name">
                                                ...
                                                <input class="flex-grow @error('new_password') is-invalid @enderror" type="password" placeholder="New password"
