            ...
            <div class="main-content-wrap">
                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                    ...
                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                        ...
                        <li>
                            <div class="text-tiny">Edit Discount</div>
                        </li>
                    </ul>
                </div>
                <div class="wg-box">
                    <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.discount.update') }}">
                        @csrf
                        @method('PUT')
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('code') is-invalid @enderror" type="text" placeholder="Discount Code" name="code" tabindex="0"
                                value="{{ $discount->code }}" aria-required="true" required="">
                        </fieldset>
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('value') is-invalid @enderror" type="number" placeholder="Discount Value" name="value" tabindex="0"
                                value="{{ $discount->value }}" aria-required="true" required="">
                        </fieldset>
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('cart_value') is-invalid @enderror" type="number" placeholder="Cart Value" name="cart_value"
                                tabindex="0" value="{{ $discount->cart_value }}" aria-required="true" required="">
                        </fieldset>
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('expiry_date') is-invalid @enderror" type="date" placeholder="Expiry Date" name="expiry_date"
                                tabindex="0" value="{{ $discount->expiry_date }}" aria-required="true" required="">
                        </fieldset>
