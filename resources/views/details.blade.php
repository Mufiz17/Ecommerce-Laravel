                ...
                <div class="col-lg-5">
                    ...
                    <div class="product-single__addtolinks">
                        @if (Cart::instance('wishlist')->content()->where('id', $products->id)->count() > 0)
                            <form
                                action="{{ route('wishlist.delete.qty', ['rowId' => Cart::instance('wishlist')->content()->where('id', $products->id)->first()->rowId]) }}"
                        ...
                        @else
                            <form name="addtocart-form" method="POST" action="{{ route('wishlist.store') }}"
                                id="wishlist-form">
                                @csrf
                                <input type="hidden" name="id" value="{{ $products->id }}">
                                <input type="hidden" name="name" value="{{ $products->name }}">
                                    ...
                                    <div class="product-card__price d-flex">
                                        <span class="money price">
                                            @if ($rproduct->sale_price)
                                                <s>{{ $rproduct->regular_price }}</s> Rp{{ $rproduct->sale_price }}
                                            @else
                                                <s>Rp{{ $rproduct->regular_price }}</s>
                                            @endif
                                        </span>
                                    </div>
