...
class CartController extends Controller
{
    ...
    public function destroy_cart_qty($rowId)
    {
    ...
    public function apply_disc(Request $request)
    {
        ...
        if (isset($discount_code)) {
            ...
            if ($discount) {
                Session::put('discount', [
                    ...
                    'cart_value' => $discount->cart_value,
                ]);
                $this->calculateDisc();
                return redirect()->back()->with('success', 'Discount has been applied!');
            } else
                return redirect()->back()->with('error', 'Invalid discount code!'); {
            }
        } else {
            return redirect()->back()->with('error', 'Please enter a discount code!');
        }
    }
    ...
    public function calculateDisc()
    {
        ...
        if (Session::has('discount')) {
            ...
            $value = Session::get('discount')['value'];
    ...
    public function delete_disc()
    {
        ...
        return redirect()->back()->with('success', 'Discount has been removed!');
    }
    ...
    public function place_an_order(Request $request)
    {
        ...
        return redirect()->route('cart.confirm', compact('order'));
    }
